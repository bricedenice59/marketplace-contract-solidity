    ...
    try {
      ...
      for (let index = 0; index < 100; index++) {
        ...
        var title = testUtils.generateRandomString(
          testUtils.getRandomNumberBetween(20, 70)
        );
        var course = {
          id: id,
          title: title,
          price: price,
          courseOwner:
            "0x8105bc7cf3656bee6a3160292d40861ab3d6dc32709f00d0a84a171940f022bd",
        };
      ...
      var result = await instance.getAllCoursesBoughtFromUser(
        "0xC188d5A9E37963EA15968425d6cdC10541ABAeDE"
      );
      console.log(result);
    } catch (e) {
