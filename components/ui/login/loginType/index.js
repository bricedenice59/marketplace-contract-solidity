export default function LoginComponent({ clickAction }) {
  return (
    <div className="flex rounded border-b-2 border-grey-dark overflow-hidden">
      <button
        onClick={clickAction}
        className="text-white shadow-border bg-blue-500 hover:bg-blue-700 py-3 px-4 border border-blue-500 font-sans tracking-wide"
      >
        Signin with Metamask
      </button>
      <div className=" bg-blue-light p-4 border border-blue-500">
